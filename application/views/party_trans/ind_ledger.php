...
$pdf->Cell(55,5,ucfirst($led['doc']),1,0,'L');
$pdf->Cell(30,5,($led['debit']==0?'':$led['debit']),1,0,'R');
$pdf->Cell(30,5,($led['credit']==0?'':$led['credit']),1,0,'R');
$pdf->Cell(30,5,$led['balance'],1,0,'R');
$pdf->Cell(20,5,$led['remark'],1,1,'L');
